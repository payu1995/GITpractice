...
public class Example4 {
	...
	//public static void main(String[] args) {
		...
		public static void main(String[] args) {
			Example4 obj=new Example4(65);//object created to load a copy non-static members into object memory
			System.out.println(obj.age);
			obj.display();
			System.out.println("***************************");
			Example4 obj2=new Example4(10);//object created to load a copy non-static members into object memory
